...
const config: Config = {
  ...
  projectName: 'teoria-das-artes-visuais',
  onBrokenLinks: 'throw',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/tcarvi-engenheiro-eduardo-leal/teoria-das-artes-visuais/edit/main/tutorial/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      title: 'teoria-das-artes-visuais',
      logo: {
        alt: 'teoria-das-artes-visuais',
        src: 'img/logo.svg',
      },
      items: [
        {
        ...
        {
          href: 'https://github.com/tcarvi-engenheiro-eduardo-leal/teoria-das-artes-visuais',
          label: 'GitHub',
          position: 'right',
        },
      ],
