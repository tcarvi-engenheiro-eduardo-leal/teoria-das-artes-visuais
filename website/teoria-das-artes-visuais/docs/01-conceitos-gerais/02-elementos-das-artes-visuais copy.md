...
### Linha 
- Traço contínuo que define formas, contornos e texturas.

### Cor 
- Diferenciada por matizes, tons, saturação e contrastes.
- Matiz das cores
- Valor das cores (Luz e Sombra)
    – Gradação de claro e escuro para criar volume.
- Sistema RYB usada na pintura com pincéis:
    - Cores primárias: Red, Yellow, Blue
- Sistema CMYK usada na impressão de equipamentos eletrônicos
    - Cores Primárias: Ciano, Magenta, Yellow, Black
- Sistema RGB usado na iluminação
